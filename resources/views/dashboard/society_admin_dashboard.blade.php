    ...
    <div class="card">
      <div class="card-body">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
          <h2 class="card-title mb-0">Variation curves</h2>
          <div class="wrapper d-flex">
            <div class="d-flex align-items-center mr-3">
              <span class="dot-indicator bg-success"></span>
              <p class="mb-0 ml-2 text-muted">Visitors</p>
            </div>
            <div class="d-flex align-items-center">
              <span class="dot-indicator bg-primary"></span>
              <p class="mb-0 ml-2 text-muted">Temperature</p>
            </div>
          </div>
        </div>
  ...
  <div class="col-lg-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        <button type="button" class="btn btn-outline-primary float-right">Download as CSV</button>
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td> 03/02/2017, 13.15 </td>
                <td class="text-danger"> 100 <i class="mdi mdi-arrow-up"></i>
                </td>
              ...
              <tr>
                ...
                <td> 03/02/2017, 14.22 </td>
                <td class="text-danger"> 101 <i class="mdi mdi-arrow-up"></i>
                </td>
                <td><button type="button" class="btn btn-primary btn-sm">View profile</button></td>
              </tr>
              <tr>
                ...
                <td> 03/02/2017, 15.15 </td>
                <td class="text-success"> 97 
                </td>
                <td><button type="button" class="btn btn-primary btn-sm">View profile</button></td>
              </tr>
              <tr>
                ...
                <td> 03/02/2017, 17.14 </td>
                <td class="text-success"> 99 
                </td>
                <td><button type="button" class="btn btn-primary btn-sm">View profile</button></td>
              </tr>
